...
describe.each([1, 2, 3, 4, 5])("critical demo run %i", () => {
  it("executes the full deterministic sequence", () => {
    ...
    expect(screen.getByLabelText("11 people waiting").querySelectorAll("svg")).toHaveLength(11);
    ...
    const atTwelve = screen.getByLabelText("12 people waiting").querySelectorAll("svg");
    ...
    const atSixteen = screen.getByLabelText("16 people waiting").querySelectorAll("svg");
    ...
    advance(DEMO_TIMING.dispatchDelay - DEMO_TIMING.extraPeopleDelay);
