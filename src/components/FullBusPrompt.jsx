...
export default function FullBusPrompt({show,onMissed}) {
  ...
  return <section className="rounded-2xl border-2 p-4 text-center" style={{background:C.card,borderColor:C.red}}>
    ...
    <h2 className="mt-1 text-sm font-extrabold" style={{color:C.text}}>Bus E1 arrived full</h2>
    <p className="mt-1 text-xs" style={{color:C.textSec}}>It filled up at KDOJ and could not pick you up at KDSE.</p>
