...
export default function CapacityBar({ load, max }) {
  return <div>
    <div className="mb-1.5 flex justify-between text-[9px] font-bold tracking-wider" style={{ color:C.textSec }}><span>SEATS AVAILABLE</span><span>{max-load} of {max} left</span></div>
