  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        {bus.etaGain > 0 && <span className="ml-auto rounded-full px-2 py-1 text-xs font-bold" title="Compared with the original schedule" style={{ background: C.successLight, color: C.success }}>{bus.etaGain} min earlier</span>}
      </div>
