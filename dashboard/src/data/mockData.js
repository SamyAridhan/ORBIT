...
export const STEPS=[
  ...
  {label:"7:30 · E1 leaves KDOJ full",busPatch:{E1:{status:"COMMUTING",position:"KDOJ → KDSE",load:28,eta:7}},stopPatch:{kdoj_e:{queue:2,level:"LOW",lastBus:0}},logs:[log("IMPACT","KDOJ stop","2_STUDENTS_MISSED_E1","E1 left KDOJ full · 2 students remain at the stop")]},
  {label:"7:37 · E1 cannot pick up the KDSE queue",busPatch:{E1:{position:"KDSE",eta:0}},stopPatch:{},logs:[log("IMPACT","KDSE stop","18_STUDENTS_MISSED_E1","E1 reached KDSE full · All 18 students remain at the stop")]},
  ...
  {label:"Earlier departure approved · 6 checks passed",busPatch:{},stopPatch:{},logs:[log("DECISION","Bus E2","EARLIER_DEPARTURE_APPROVED","Bus E2 will leave at 7:40 instead of 7:50 · All 6 safety checks passed, including a safe 10-minute gap behind E1")]},
  {label:"Bus E2 is assigned to the overflow",busPatch:{},stopPatch:{kdse_e:{claimedBy:"E2"},kdoj_e:{claimedBy:"E2"}},logs:[]},
  {label:"7:40 · Bus E2 starts the relief trip",busPatch:{E2:{status:"COMMUTING",position:"KDOJ → KDSE",eta:7,etaGain:10}},stopPatch:{},logs:[log("ACTION","Bus E2","RELIEF_TRIP_STARTED","E2 picked up the 2 students at KDOJ and left at 7:40 · Expected at KDSE at 7:47")]},
  ...
  {label:"7:47 · Both overflow queues are clear",busPatch:{E2:{status:"BOARDING",position:"KDSE",load:20,eta:0,etaGain:10}},stopPatch:{kdse_e:{queue:0,level:"LOW",claimedBy:null,lastBus:0}},logs:[log("RESOLVED","Bus E service","OVERFLOW_CLEARED","Nobody remains at KDOJ or KDSE · Bus E2 now has 20 of 28 seats used")]},
];
...
export const SCENARIO_TIMES=["07:29:50","07:30:00","07:37:00","07:37:10","07:37:20","07:38:00","07:38:10","07:40:00","07:40:10","07:47:00"];
